...
describe("createClass-mixins-dev", () => {
    "use strict";
    ...
    it("should warn if rebind autobind", () => {
        spyOn(console, "error");
        ...
        for (var i = 0; i < 3; i++) {
            expect(console.error.calls.argsFor(i)[0]).toBe(
                "Warning: `ComponentClass.custom` is an auto-binded method: There is no need for another bind."
            );
        }

        // should warn if context changed
        instance.custom.bind({});
        expect(console.error.calls.count()).toBe(4);
        expect(console.error.calls.argsFor(3)[0]).toBe(
            "Warning: `ComponentClass.custom` is an auto-binded method: Binding the method to another context will not change the context."
        );
    ...
    it("should warn if undefined mixin", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Warning: Only not null typeof 'object' can be used as mixins. Given mixin: undefined."
        );
    });

    it("should warn if null mixin", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Warning: Only not null typeof 'object' can be used as mixins. Given mixin: null."
        );
    });

    it("should warn if nested undefined mixin", () => {
        spyOn(console, "error");
    ...
    it("should warn if nested null mixin", () => {
        spyOn(console, "error");
    ...
    it("should throw if mixin is an element", () => {
        expect(() => {
            vrdom.createClass({
                mixins: [<div />],
            ...
            "A component element cannot be used a mixin. May be you wanted to use the element type prototype."
        );
    });

    it("should throw if mixin is a Component class", () => {
        expect(() => {
            var ComponentClass = vrdom.createClass({
                render: function() {
                    return <div />;
            ...
            "A function cannot be used as a mixin. May be you wanted to use the prototype as mixin."
        );
    });

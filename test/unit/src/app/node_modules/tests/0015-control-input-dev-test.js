...
describe("control-input-dev", () => {
    ...
    it("should not change previously setted value when setting defaultValue", () => {
        spyOn(console, "error"); // suppress wargings
    ...
    it("should control input text with value as read only input", () => {
        ...
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "<input> element will behave as a read-only `value` element. " +
    ...
    it("should control input checkbox with checked as read only input", () => {
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "<input> element will behave as a read-only `checked` element. " +
            "You should consider setting `readOnly` prop if it is your meaning. " +
    ...
    it("should warn if value is null", () => {
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "`value` prop on `<input type=\"text\" />` should not be null. Use undefined or '' to clear content."
        );
    });

    it("should warn if value change from uncontrolled to controlled", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Input elements should be either controlled or uncontrolled: <input type=\"text\" /> is changing from uncontrolled to controlled."
        );

        vrdom.reset();
    });

    it("should warn if value change from controlled to uncontrolled", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Input elements should be either controlled or uncontrolled: <input type=\"text\" /> is changing from controlled to uncontrolled."
        );

        vrdom.reset();
    });

    it("should warn if value and defaultValue", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Input elements should be either controlled or uncontrolled: <input /> has both `value` and `defaultValue` props."
        );
    });

    it("should warn if value is setted without readOnly nor onChange", () => {
        spyOn(console, "error");
    ...
    it("should warn if checked is setted without readOnly nor onChange", () => {
        spyOn(console, "error");
    ...
    it("should warn if checked is null", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "`checked` prop on `<input type=\"checkbox\" />` should not be null. Use either true or false."
        );
    });

    it("should warn if checked change from uncontrolled to controlled", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Input elements should be either controlled or uncontrolled: <input type=\"checkbox\" /> is changing from uncontrolled to controlled."
        );

        vrdom.reset();
    });

    it("should warn if checked change from controlled to uncontrolled", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Input elements should be either controlled or uncontrolled: <input type=\"checkbox\" /> is changing from controlled to uncontrolled."
        );

        vrdom.reset();
    });

    it("should warn if checked and defaultChecked", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Input elements should be either controlled or uncontrolled: <input type=\"checkbox\" /> has both `checked` and `defaultChecked` props."
        );
    });

    it("should throw if both checkedLink and valueLink on input text", () => {
        var ValueLinkComponent = vrdom.createClass({
            render: function() {
        ...
        expect(() => {
            ...
            "It is not allowed to set both checkedLink and valueLink props."
        );
    });

    it("should throw if both checkedLink and valueLink on input checkbox", () => {
        var ValueLinkComponent = vrdom.createClass({
            render: function() {
    ...
    it("should throw if both onChange and valueLink on input text", () => {
        var ValueLinkComponent = vrdom.createClass({
            render: function() {
        ...
        expect(() => {
            ...
            "It is not allowed to set valueLink prop and value or onChange prop."
        );
    });

    it("should throw if both onChange and valueLink on input checkbox", () => {
        var ValueLinkComponent = vrdom.createClass({
            render: function() {
        ...
        expect(() => {
            ...
            "It is not allowed to set checkedLink prop and checked or onChange prop."
        );
    });

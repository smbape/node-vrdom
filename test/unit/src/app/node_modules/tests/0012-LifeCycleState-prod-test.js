...
describe("LifeCycleState-prod", () => {
    ...
    it("should handle multiple setState/replaceState/forceUpdate", () => {
        ...
        expectLogs(logs, [
            ...
            ["MessyComponent", "setRef", { step: "willMount-2" }, [jasmine.any(HTMLElement)]], // setRef should be called just after rendered element is mounted
        ...
        expectLogs(logs, [
            ...
            ["MessyComponent", "setRef", { step: "didUpdate" }, [null]],
            // ================================
            // Destruction end
        ]);

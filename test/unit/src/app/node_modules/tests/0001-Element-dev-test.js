...
describe("Element-dev", () => {
    ...
    it("should warn for keys when using array of Component as children", () => {
        spyOn(console, "error");
    ...
    it("should add owner info in warning for keys", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.argsFor(0)[0]).toContain(
            ...
            "It was created in `GrandParent.render()`."
        );
    });

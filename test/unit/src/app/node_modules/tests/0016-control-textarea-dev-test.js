...
describe("control-textarea-dev", () => {
    ...
    it("should control textarea with value as read only textarea", () => {
        ...
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "<textarea> element will behave as a read-only `value` element. " +
    ...
    it("should warn if value is null", () => {
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "`value` prop on `<textarea>` should not be null. Use undefined or '' to clear content."
        );
    });
    ...
    it("should warn if value and defaultValue", () => {
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Textarea elements should be either controlled or uncontrolled: <textarea> has both `value` and `defaultValue` props."
        );
    });

    it("should throw if more than one child", () => {
        spyOn(console, "error"); // suppress warning

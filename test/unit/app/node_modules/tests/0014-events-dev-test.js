...
describe("events-dev", () => {
    ...
    it("should unregister event on DOM element ", () => {
        ...
        for (var name in eventNames) {
            ...
            domNode = vrdom.render(<div { ...props } />, container);
    ...
    it("should catch on error", (done) => {
        ...
        class Component extends vrdom.Component {
            ...
            render() {
                var src = "http://" + String(Math.random()).slice(2) + ".com/video.mp4";
                return (
    ...
    it("should listen for resize on media element", () => {
        ...
        var domNode = vrdom.render(<video onResize={ () => ++count }>
            <source src={"http://" + String(Math.random()).slice(2) + ".com/video.mp4"} type="video/mp4" />
        </video>, container);

...
describe("render-update-dev", () => {
    ...
    it("should not re-render if shouldComponentUpdate return false, but still update props and state", () => {
        var childRenders = 0;
        var childWillUpdate = 0;
        var childDidUpdate = 0;
        ...
        var parentRenders = 0;
        var parentWillUpdate = 0;
        var parentDidUpdate = 0;
        ...
        var element = <Parent prop="value" />;
        vrdom.render(element, container);
        expect(parentRenders).toBe(1);
        expect(parentWillUpdate).toBe(0);
        expect(parentDidUpdate).toBe(0);
        expect(childRenders).toBe(1);
        expect(childWillUpdate).toBe(0);
        ...
        element.props.prop = "new value";
        instance.forceUpdate();
        expect(parentRenders).toBe(2);
        expect(parentWillUpdate).toBe(1);
        expect(parentDidUpdate).toBe(1);
        expect(childRenders).toBe(2);
        expect(childWillUpdate).toBe(1);
        expect(childDidUpdate).toBe(1);
        expect(instance.props).toEqual({ prop: "new value" });
        expect(instance.state).toEqual({ key: "value" });
    });

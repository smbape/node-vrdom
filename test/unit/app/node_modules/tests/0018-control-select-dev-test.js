...
describe("control-select-dev", () => {
    ...
    it("should warn if value is null", () => {
        ...
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "`value` prop on `<select>` should not be null. Use undefined or '' to clear content."
        );
    });
    ...
    it("should warn if value change from uncontrolled to controlled", () => {
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Select elements should be either controlled or uncontrolled: <select> is changing from uncontrolled to controlled."
        );
    ...
    it("should warn if value change from controlled to uncontrolled", () => {
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Select elements should be either controlled or uncontrolled: <select> is changing from controlled to uncontrolled."
        );

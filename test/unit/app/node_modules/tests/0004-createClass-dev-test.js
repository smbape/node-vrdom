...
describe("createClass-dev", () => {
    ...
    it("should enforce `render` specification", () => {
        expect(() => vrdom.createClass({})).toThrowError(
            "vrdom.createClass(...): prototype has no `render` method."
        );
    });
    ...
    it("should refuse non objects or array as initial state", () => {
        [ "string", 0, undefined, [] ].forEach(function(initialState) {
            ...
            expect(() => new ComponentClass()).toThrowError(
                "ComponentClass.getInitialState(): Invalid state returned. Expecting typeof 'object' and not Array."
            );
        });
    });

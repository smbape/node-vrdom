...
describe("render-dev", () => {
    ...
    it("should use first attribute when duplicate attributes", () => {
        ...
        expect(console.error.calls.argsFor(0)[0]).toContain(
            "Warning: For <div>, prefer using the interface property name `id` instead of `ID`."
        );
        expect(console.error.calls.argsFor(1)[0]).toContain(
            "Warning: ID is normalized to the same prop as `id`. Only `id` will be used."
        );
    ...
    it("should handle style property", () => {
        ...
        expect(console.error.calls.count()).toBe(2);
        expect(console.error.calls.argsFor(0)[0]).toContain(
            "Warning: For <style>, prefer using the interface property name `backgroundSize` instead of `background-size`."
        );
        expect(console.error.calls.argsFor(1)[0]).toContain(
            "Warning: For <style>, prefer using the interface property name `lineHeight` instead of `line-height`."
        );
    });
    ...
    it("should use last style property when duplicated prop", () => {
        ...
        expect(console.error.calls.count()).toBe(2);
        expect(console.error.calls.argsFor(0)[0]).toContain(
            "Warning: For <style>, prefer using the interface property name `left` instead of `LEFT`."
        );
        expect(console.error.calls.argsFor(1)[0]).toContain(
            "Warning: left is normalized to the same style prop as `LEFT`. `left` will be used."
        );
    ...
    describe("Warnings", () => {
        it("should warn when changing props in constructor", () => {
            class Component extends vrdom.Component {
            ...
            expect(console.error.calls.argsFor(0)[0]).toContain(
                "Component(...): Avoid changing props in constructor since it will be overrided."
            );

        });

        it("should warn when changing context in constructor", () => {
            class Component extends vrdom.Component {
                constructor(props, context) {
                    super(props, context);
                    this.context = {};
            ...
            expect(console.error.calls.count()).toBe(1);
            expect(console.error.calls.argsFor(0)[0]).toContain(
                "Component(...): Avoid changing context in constructor since it will be overrided."
            );

        });

        it("should warn when componentDidUnmount is defined", () => {
            class Component extends vrdom.Component {
                componentDidUnmount(){
                    // do nothing
                }
            ...
            expect(console.error.calls.count()).toBe(1);
            expect(console.error.calls.argsFor(0)[0]).toContain(
                "`Component.componentDidUnmount()` is not a known method. Did you mean `Component.componentWillUnmount()`?"
            );

        });

        it("should warn if rendering in document.body", (done) => {
        ...
        it("should prevent setting invalid attribute name", () => {
            spyOn(console, "error");
            ...
            expect(console.error.calls.argsFor(0)[0]).toEqual(
                "Warning: Invalid attribute name: `\" onclick=\"alert(22)\" \"`"
            );

            vrdom.reset();
        });

        it("should prevent directly setting property `innerHTML`", () => {
            spyOn(console, "error");
        ...
        it("should warn component is `contentEditable` and contains `children`", () => {
            spyOn(console, "error");
            vrdom.render(<div contentEditable={ true }>child</div>, document.createElement("div"));
            expect(console.error.calls.count()).toBe(1);
            expect(console.error.calls.argsFor(0)[0]).toContain("Warning: `contentEditable` and `children` props are setted. This will lead to unpredictable behaviour if the user edit the content.");
        });
        ...
        it("should warn for vrdom.render in render", () => {
            spyOn(console, "error");
            ...
            expect(console.error.calls.argsFor(0)[0]).toBe(
                "Warning: vrdom.render(...): `vrdom.render(...)` cannot be nested in the render method of another component." +
    ...
    describe("Errors", () => {
        it("should throw on invalid callback", () => {
            ...
            expect(() => vrdom.render(<div />, container, "string")).toThrowError(
                "vrdom.render(...): Invalid callback. If provided, callback must be a function, but got `\"string\"`."
            );
            expect(() => vrdom.render(<div />, container, {})).toThrowError(
                "vrdom.render(...): Invalid callback. If provided, callback must be a function, but got `{}`."
            );
            expect(() => vrdom.render(<div />, container, new Dummy())).toThrowError(
                "vrdom.render(...): Invalid callback. If provided, callback must be a function, but got `Dummy (keys: key0, key1)`."
            );
        });
        ...
        it("should throw on invalid container", () => {
            ...
            [true, false, 0, 1, null, undefined, Function.prototype, {}, [container]].forEach((container) => {
                expect(() => vrdom.render(<div></div>, container)).toThrowError(
                    "vrdom.render(): container is not a DOM node."
                );
            });
        });
        ...
        it("shoud throw on invalid elements", () => {
            ...
            expect(() => {
                ...
                "vrdom.render(): Invalid component element."
            );
            ...
            expect(() => {
                ...
                "Invalid child element {}. It was created in `CompositeComponent.render()`."
            );
            ...
            expect(() => {
                ...
                "vrdom.render(): Invalid component element. " +
                "Perhaps you mean <div /> instead of 'div'."
            );
            ...
            expect(() => {
                ...
                "vrdom.render(): Invalid component element. " +
                "Perhaps you mean <CompositeComponent /> instead of CompositeComponent."
            );

            expect(() => {
                vrdom.render(<CompositeComponent />, container);
            }).toThrowError(
                "CompositeComponent.render(): Invalid element returned. Valid elements are null and objects created by vrdom.createElement."
            );

            var Undefined;
            expect(() => vrdom.render(<Undefined />, document.createElement("div"))).toThrowError(
                "vrdom.render(...): Element type is null or undefined."
            );

            var Null = null;
            expect(() => vrdom.render(<Null />, document.createElement("div"))).toThrowError(
                "vrdom.render(...): Element type is null or undefined."
            );
        });

        it("should throw when adding children in elements", () => {
            expect(() => {
                var container = document.createElement("div");
                vrdom.render(<input>children</input>, container);
            }).toThrowError(
                "<input /> cannot have `children` nor `dangerouslySetInnerHTML`."
            );
        });

        it("should throw when setting innerHTML in elements", () => {
            expect(() => {
                var container = document.createElement("div");
        ...
        it("should prevent setting children and innerHTML", () => {
            var container = document.createElement("div");

            expect(() => {
                vrdom.render(<div dangerouslySetInnerHTML={{__html: "inner"}}>child</div>, container);
            }).toThrowError(
                "You can only set one of `children` or `dangerouslySetInnerHTML`."
            );
        ...
        it("should check dangerouslySetInnerHTML", () => {
            var container = document.createElement("div");
            [0, "string", Function.prototype, {}].forEach((html) => {
                expect(() => {
                    vrdom.render(<div dangerouslySetInnerHTML={ html } />, container);
                }).toThrowError(
                    "`dangerouslySetInnerHTML` must be in the form `{__html: ...}`."
                );
            });
        });

        it("should expect stype to be a mapping from style properties to values", () => {
            [true, false, 0, 1, "display: none"].forEach((style) => {
                expect(() => {
                    vrdom.render(<div style={ style } />, document.createElement("div"));
                }).toThrowError(
                    "Expect style prop to be a key-value object."
                );
            });
        });

        it("should expect stype to be a mapping from style properties to values and add owner info", () => {
            [true, false, 0, 1, "display: none"].forEach((style) => {
                expect(() => {
                    class CompositeComponent extends vrdom.Component {
                        render() {
                    ...
                    "Expect style prop to be a key-value object. This DOM node was rendered by `CompositeComponent`."
                );
            });
        });
        ...
        it("should throw when childContextTypes is not defined", () => {
            class Child extends vrdom.Component {
                static contextTypes = {
                    text: PropTypes.string
                };
            ...
            expect(() => {
               ...
               "Parent.getChildContext(): childContextTypes must be defined in order to use getChildContext()."
            );
        });

        it("should throw when getChildContext has a key not in childContextTypes", () => {
            class Child extends vrdom.Component {
                static contextTypes = {
                    text: PropTypes.string
                };
            ...
            expect(() => {
               ...
               "Parent.getChildContext(): key \"textn\" is not defined in childContextTypes."
            );
        });

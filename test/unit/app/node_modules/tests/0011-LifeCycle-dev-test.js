...
describe("LifeCycle-dev", () => {
    ...
    beforeAll((done) => {
        ...
        require(["vrdom-dev", "lodash"], function() {
            vrdom = arguments[0];
            _ = arguments[1];
    ...
    it("should validate inital render cycle", () => {
        ...
        expect(logs).toEqual([
            ...
            ["LoggerComponent", "setRef", [jasmine.any(HTMLElement), "mount"]], // setRef should be called just after rendered element is mounted
            ...
            ["LoggerComponent", "setRef", [null, "unmount"]],
            // ================================
            // Destruction end
    ...
    it("should treat plain object instance as Component instance", () => {
        ...
        expect(logs).toEqual([
            ...
            ["Object", "render", []],
            ["Object", "setRef", [jasmine.any(HTMLElement), "mount"]], // setRef should be called just after rendered element is mounted
    ...
    it("should handle setState in componentDidMount", () => {
        ...
        var expected = [
            ...
            ["Parent", "render", []],
            ["Parent", "setRef", [jasmine.any(HTMLElement), "mount"]], // setRef should be called just after rendered element is mounted
            ...
            ["Parent", "render", []],
            ["Parent", "setRef", [null, "unmount"]], // previous child will be destroyed because of new child returned by render
            ...
            ["Child", "render", []],
            ["Child", "setRef", [jasmine.any(HTMLElement), "mount"]],
            ["Child", "componentDidMount", []],
            ["Parent", "setRef", [jasmine.any(Child), "mount"]], // new child has been created
            // ================================
    ...
    it("should determine isMounted for createClass", () => {
        ...
        expect(console.error.calls.argsFor(0)[0]).toContain(
            "`Component.render()` is calling `Component.isMounted()`. DOM node may not be setted yet or may change after render."
        );
    });
    ...
    it("should allow vrdom.render in componentDidMount/componentDidUpdate and vrdom.unmountComponentAtNode in componentWillUnmount", () => {
        ...
        expectLogs(logs, [
            ...
            ["SubComponent", "render", []],
            ["SubComponent", "setRef", [jasmine.any(HTMLElement), "mount"]],
            ...
            ["ContentComponent", "setRef", [jasmine.any(HTMLElement), "mount"]],
            ["ContentComponent", "componentDidMount", []],
            ["MainComponent", "setRef", [jasmine.any(ContentComponent), "mount"]], // setRef should be called just after rendered element is mounted
            // ================================
            // ContentComponent Initialization end

            ["MainComponent", "setRef", [jasmine.any(SubComponent), "mount"]], // setRef should be called just after rendered element is mounted
            // ================================
        ...
        expectLogs(logs, [
            ...
            // To prevent ref owner from using child after destruction,
            // ref should be set to null before starting child destruction.
            ["MainComponent", "setRef", [null, "unmount"]], // unref SubComponent
            ...
            // To prevent ref owner from using child after destruction,
            // ref should be set to null before starting child destruction.
            ["MainComponent", "setRef", [null, "unmount"]], // unref ContentComponent
            ...
            // To prevent ref owner from using child after destruction,
            // ref should be set to null before starting child destruction.
            ["ContentComponent", "setRef", [null, "unmount"]], // unref div element
            // ================================
            ...
            // To prevent ref owner from using child after destruction,
            // ref should be set to null before starting child destruction.
            ["SubComponent", "setRef", [null, "unmount"]], // unref div element
            // ================================
    ...
    it("should warn if `setState` in render", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Warning: `Component.setState(...)` during `Component.render()` will only be applied on next rendering cycle." +
    ...
    it("should warn if `setState` on unmounted components", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Warning: `Component.setState(...)` is called on an unmounted `Component`."
        );

        vrdom.unmountComponentAtNode(container);
    });

    it("should warn if `forceUpdate` on unmounted components", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Warning: `Component.forceUpdate(...)` is called on an unmounted `Component`."
        );

        vrdom.unmountComponentAtNode(container);
    });

    it("should warn if `replaceState` on unmounted components", () => {
        spyOn(console, "error");
        ...
        expect(console.error.calls.count()).toBe(1);
        expect(console.error.calls.argsFor(0)[0]).toBe(
            "Warning: `Component.replaceState(...)` is called on an unmounted `Component`."
        );
